<template>
    <div class="">
        <div class="gra tamano mx-5 ">
            <div class="flex justify-center ">
                <img :src="pokemonStore.pokemonsPlayerUno[0].image" class="w-60 mr-16" >
                <img :src="pokemonStore.pokemonsPlayerUno[1].image" class="w-60 mr-16" >
                <img :src="pokemonStore.pokemonsPlayerUno[2].image" class="w-60 mr-16" >
            </div>
            <div class="flex justify-center">
                <img :src="pokemonStore.pokemonsPlayerUno[3].image" class="w-60 ml-16" >
                <img :src="pokemonStore.pokemonsPlayerUno[4].image" class="w-60 ml-16" >
                <img :src="pokemonStore.pokemonsPlayerUno[5].image" class="w-60 ml-16" >
            </div>
        </div>
    </div>
...
console.log(pokemonStore.pokemonsPlayerUno)
...
.gra {
  ...
  background: radial-gradient(#ffffff, #f6faa7);
}
.tamano{
